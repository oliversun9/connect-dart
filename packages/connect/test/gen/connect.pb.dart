...
class Connect extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'connect'),
...
class ConnectServiceApi {
  ...
  $async.Future<Connect> getConnect($pb.ClientContext? ctx, Connect request) =>
      _client.invoke<Connect>(
          ctx, 'ConnectService', 'GetConnect', request, Connect());
}
